...
public class DynamicListView<T> extends ListView {
    ...
    public ArrayList<T> mDynamicArrayList;
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mDynamicArrayList, originalItem, getPositionForView(switchView));
    ...
    public void setDynamicArrayList(ArrayList<T> dynArrayList) {
        mDynamicArrayList = dynArrayList;
    }
